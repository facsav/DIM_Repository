                ...
                <div class="row">
                    <div class="col-12" style="z-index: 1000;">
                        <ul>
                            ...
                            <li>
                                <div class="cont-buscadorito filtro WebsTotales"><a href="../index.html">Home</a> 
                                <p style="display: none;">home - inicio</p>
                                </div>
                            </li>
                            
                            <li>
                                <div class="cont-buscadorito filtro WebsTotales"><a href="../w25 ver mas info/index.html">Mas información</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" style="margin-top: 28px;">
                            ...
                            <li onmouseover="showImage(this, './img/dropdown/preguntas.png'); highlightElement(this)" onmouseout="hideImage(this); unhighlightElement(this)">
                                <a class="dropdown-item" href="./../w6 Preguntas frecuentes/index.html">Preguntas frecuentes</a>
                                <div class="image-container">
                                    <img class="image-hidden" src="" alt="">
                                </div>
                                <div class="highlight-arrow"></div>
        ...
        <div class="row justify-content-center text-center">
            ...
            <div class="col-12 col-lg-3  text-start">
                <ul>
                    ...
                    <li><a href="../w6 Preguntas frecuentes/index.html">Preguntas frecuentes</a></li>
